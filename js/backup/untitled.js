...
$(function () {
    ...
    function buildLevel() {
        ...
        for (i = 0; i < 200; i += 1) {
            level.push(sidescroller.block.blockFactory(700 + (i * 16), 290, "block01Beach", true, function (actor, direction) {
    ...
    function animateClouds() {
        cloudPos += 1;
        document.querySelector("canvas").style.backgroundPosition = backgroundOffset / 2 + "px 0px";
    }
    setTimeout(function () {
    ...
    function isInsideScreen(block) {
        if (block.yPos + globalPosX < canvas.width - 10 &&
            block.yPos + globalPosX > 0) {
            return true;
        } else {
            return false;
        }
    ...
    function isInVicinity(block, entity) {
        if (block.yPos + globalPosX < entity.yPos + globalPosX + 40 &&
            block.yPos + globalPosX > entity.yPos + globalPosX - 40 &&
            block.xPos < entity.xPos + 40 &&
            block.xPos > entity.xPos - 40) {
            return true;
        } else {
            return false;
    ...
    function collision(entity) {
        ...
        if (entity.xPos > canvas.height) {
            ...
            for (i = 0; i < level.length; i += 1) {
                ...
                if (level[i].hasCollision === true) {
                    ...
                    } else if (entity.counter >= 13000) {
                        // console.log(entity.counter);
                        entity.counter = 0;
                        entity.onGround = false;
                    } else {
                        entity.counter += 1;
        ...
        if (b === undefined) {
            ...
            var randomNumb = Math.random() - Math.random();
            //console.log(randomNumb);
            if (entity.counter >= 13000) {
                entity.onGround = false;
                b = undefined;

            }
        } else if ((entity.yPos > b.yPos + b.canvas.width || entity.yPos < b.yPos) && (entity.xPos < b.xPos || entity.xPos > b.xPos + b.canvas.height)) {
            b = undefined;
        }
    ...
    function render() {
        ...
        // //3d test
        // ctx.drawImage(background2, Math.round((globalPosX * 0.5) + (127 * 1)), 220, background2.width * 1.5 - globalPosX / 10, background2.height * 1.5);
        // ctx.drawImage(background2, Math.round((globalPosX * 0.53) + (127 * 1)), 220, background2.width * 1.5 - globalPosX / 10, background2.height * 1.5);
        // ctx.drawImage(background2, Math.round((globalPosX * 0.56) + (127 * 1)), 220, background2.width * 1.5 - globalPosX / 10, background2.height * 1.5);
        // ctx.drawImage(background2, Math.round((globalPosX * 0.59) + (127 * 1)), 220, background2.width * 1.5 - globalPosX / 10, background2.height * 1.5);
        // ctx.drawImage(background2, Math.round((globalPosX * 0.62) + (127 * 1)), 220, background2.width * 1.5 - globalPosX / 10, background2.height * 1.5);
    ...
    canvas.addEventListener("mousedown", function (e) {
        mouseDown = true;
        level.push(sidescroller.block.blockFactory(mouseX - globalPosX, mouseY, "block01", true));
    }, false);
    ...
    canvas.addEventListener("mousemove", function (e) {
        ...
        mouseX = e.offsetX;
        if (mouseDown === true) {
            level.push(sidescroller.block.blockFactory(mouseX - globalPosX, mouseY, "block01Beach", true));
        }
